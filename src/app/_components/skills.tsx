                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">                        
                        <div className="space-y-6 shadow-lg border-gray-100 border bg-white p-4 md:p-8 rounded-2xl mx-4">
                            ...
                            { skillsLg.map((item, index) => (
                                <li key={index} className="flex items-center flex-col md:flex-row bg-[#e9e9e9] w-fit mx-auto rounded-2xl hover:bg-[#008584] group p-2">
                                    <div className="p-2 md:p-2">
                                        <i className={`${item.icon} text-[#008584] text-5xl md:text-4xl group-hover:text-white`} ></i>
                                    </div>
                                    <div className="px-3 pb-2 md:px-2 md:pb-3 md:pt-3">
                                        <h3 className="text-black font-semibold group-hover:text-white text-center">{ item.title }</h3>
                                        <div>
                        ...
                        <div className="space-y-6 shadow-lg border-gray-100 border bg-white p-8 rounded-2xl mx-4">
                            ...
                            <div key={index} className="relative pl-6 sm:pl-8 space-y-6 sm:space-y-8 before:content-[''] before:absolute before:left-2 before:top-2 before:bottom-2 before:w-0.5 before:bg-gray-200">
                                <div className="relative before:content-[''] before:absolute before:left-[-1.25rem] sm:before:left-[-2rem] before:top-2 before:w-3 sm:before:w-4 before:h-3 sm:before:h-4 before:bg-[#008584] before:rounded-full before:shadow-lg">
                                    <h4 className="text-lg font-semibold text-gray-900">{item.empresa}</h4>
                                    <p className="text-sm text-[#008584] mb-2">{item.periodo}</p>
