                    ...
                    <div className="grid sm:grid-cols-1 lg:grid-cols-3 gap-2">                        
                        <div className="space-y-6 shadow-lg border-gray-100 border bg-white p-4 md:p-8 rounded-2xl mx-4">
                            <div className='flex items-center justify center'>
                                <Link href='https://radardomarketing.com.br/' target='_blank'><Image  data-aos="zoom-out-down"  src={radarImg} className="" quality={100} alt="Print da tela inicial do site da radar do marketing"/></Link>
                            </div>
                        ...
                        <div className="space-y-6 shadow-lg border-gray-100 border bg-white p-4 md:p-8 rounded-2xl mx-4">
                            <div className='flex items-center justify center'>
                                <Link href='http://malgueirocampos.com.br/' target='_blank'><Image  data-aos="zoom-out-down"  src={mczImg} className="" quality={100} alt="Print da tela inicial do site Malgueiro Campos"/></Link>
                            </div>
